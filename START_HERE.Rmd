...
Note: Since there are more settings than this subset, the CheckParams() function will fill in the blanks with defaults! The same is true for the generate structure parameters (the generate argument is the switch).
```{r}
