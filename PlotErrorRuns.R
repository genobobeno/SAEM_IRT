WorkingDirectory = "~/Documents/Rutgers_GSE/Camilli/ParSAEM/SAEM_IRT/"
...
MCErrorFunction<-function(x,burnin=800,start=600) {
...
CLTErrorFunction<-function(x,burnin=800,start=600) {
  for (iii in 1:dim(x$Aiter)[2]) {
    Atrim = start+10*1:(floor((burnin-start)/10))
    if (iii==1) {
...
# for (p in 1:ncol(gen.xi)) {
p=1
yU<-max(stats1D[,grepl("A1_ERR",colnames(stats1D))])
ifelse(p==ncol(gen.xi),pt<-"B",pt<-paste("A",p,sep=""))
plot(gen.xi[,p],rep(c(0,yU),sim.list[[d]]$J/2),type="n",
        main=expression("Slope Error Estimates : 2PNO"),ylim=c(0,yU),
        xlab=pt,ylab="Approximate Error")
points(gen.xi[,p],stats1D$A1_ERR_CLT_Ann,pch=0,col=1)
points(gen.xi[,p],stats1D$A1_ERR_CLT_Burn,pch=1,col=1)
points(gen.xi[,p],stats1D$A1_ERR_CLT_Emp,pch=2,col=1)
points(gen.xi[,p],stats1D$A1_ERR_LMI_Iter,pch=3,col=1)
points(gen.xi[,p],stats1D$A1_ERR_LMI_Iter_Emp_2PL,pch=4,col=1)
points(gen.xi[,p],stats1D$A1_ERR_LMI_Iter_Emp_2PNO,pch=5,col=1)
points(gen.xi[,p],stats1D$A1_ERR_Simple_2PL,pch=6,col=1)
points(gen.xi[,p],stats1D$A1_ERR_Simple_2PNO,pch=7,col=1)
points(gen.xi[,p],stats1D$A1_ERR_MCMC_Ann,pch=8,col=1)
points(gen.xi[,p],stats1D$A1_ERR_MCMC_Burn,pch=9,col=1)
points(gen.xi[,p],stats1D$A1_ERR_MCMC_Emp,pch=10,col=1)
points(gen.xi[,p],stats1D$A1_RMSE,pch=21,bg=4,col=1)
#   legend("top",c("ConvIRT","MCMC","PostIRT","Post2PNO","OneIRT","One2PNO","RMSE"),pch=c(16,16,16,16,16,16,1),col=c(2,4,6,5,3,1,1))
p=2
yU<-max(stats1D[,grepl("B_ERR",colnames(stats1D))])
ifelse(p==ncol(gen.xi),pt<-"B",pt<-paste("A",p,sep=""))
plot(gen.xi[,p],rep(c(0,yU),sim.list[[d]]$J/2),type="n",
     main=expression("Intercept Error Estimates : 2PNO"),ylim=c(0,yU),
     xlab=pt,ylab="Approximate Error")
points(gen.xi[,p],stats1D$B_ERR_CLT_Ann,pch=0,col=1)
points(gen.xi[,p],stats1D$B_ERR_CLT_Burn,pch=1,col=1)
points(gen.xi[,p],stats1D$B_ERR_CLT_Emp,pch=2,col=1)
points(gen.xi[,p],stats1D$B_ERR_LMI_Iter,pch=3,col=1)
points(gen.xi[,p],stats1D$B_ERR_LMI_Iter_Emp_2PL,pch=4,col=1)
points(gen.xi[,p],stats1D$B_ERR_LMI_Iter_Emp_2PNO,pch=5,col=1)
points(gen.xi[,p],stats1D$B_ERR_Simple_2PL,pch=6,col=1)
points(gen.xi[,p],stats1D$B_ERR_Simple_2PNO,pch=7,col=1)
points(gen.xi[,p],stats1D$B_ERR_MCMC_Ann,pch=8,col=1)
points(gen.xi[,p],stats1D$B_ERR_MCMC_Burn,pch=9,col=1)
points(gen.xi[,p],stats1D$B_ERR_MCMC_Emp,pch=10,col=1)
points(gen.xi[,p],stats1D$B_RMSE,pch=21,bg=4,col=1)


pdf("ErrorFitStats1D.pdf",width=8,height=8)
nf <- layout(matrix(c(1,2,3,4,6,7,8,9,5,5,5,5,10,10,10,10),8,2), c(16,16), c(4,3,3,5,4,3,3,5), TRUE)
#layout.show(nf)
#SIZE=10000

YR<-range(c(stats1D$A1_sd_oERR,stats1D$A1_sd_LMIo,stats1D$A1_sd_MCE,stats1D$A1_sd_LMI)/stats1D$A1_sd)
fitA1oE<-loess(A1_sd_oERR/A1_sd~A1,data=stats1D,span=0.5)
fitA1oE
sd(fitA1oE$residuals)
#fitA1o<-lm(A1_sd_LMIo/A1_sd~A1,data=stats1D)
fitA1o<-loess(A1_sd_LMIo/A1_sd~A1,data=stats1D[!stats1D$A1_sd_LMIo==0,],span=0.5)
fitA1o
sd(fitA1o$residuals)
#fitA1MC<-lm(A1_sd_MCE/A1_sd~A1,data=stats1D)
fitA1MC<-loess(A1_sd_MCE/A1_sd~A1,data=stats1D,span=0.5)
fitA1MC
sd(fitA1MC$residuals)
#fitA1LM<-lm(A1_sd_LMI/A1_sd~A1,data=stats1D)
fitA1LM<-loess(A1_sd_LMI/A1_sd~A1,data=stats1D,span=0.5)
fitA1LM
sd(fitA1LM$residuals)

ticks <- pretty(YR)[-c(length(pretty(YR))-1:0)]
labels <- format(ticks, big.mark=",", scientific=FALSE)
m.b = 0.25
par(mar=c(m.b,4,2,m.b))
plot(stats1D$A1,stats1D$A1_sd_MCE/stats1D$A1_sd,yaxt="n",pch=16,col=2,#cex=(SIZE-5000+stats1D$N)/SIZE,
     ylim=YR,xaxt="n",ylab=NA)
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
text(range(stats1D$A1)[1]+0.8*(range(stats1D$A1)[2]-range(stats1D$A1)[1]),0.85*YR[2],"MCMC")
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1MC,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=4)
par(mar=c(m.b,4,m.b,m.b))
plot(stats1D$A1,stats1D$A1_sd_LMI/stats1D$A1_sd,yaxt="n",
     pch=16,col=4,xaxt="n",#cex=(SIZE-5000+stats1D$N)/SIZE,
     ylim=YR,ylab=NA)
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
text(range(stats1D$A1)[1]+0.8*(range(stats1D$A1)[2]-range(stats1D$A1)[1]),0.85*YR[2],"SAEM")
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1LM,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=5)
plot(stats1D$A1,stats1D$A1_sd_oERR/stats1D$A1_sd,xaxt="n",pch=16,#cex=(SIZE-5000+stats1D$N)/SIZE,
     ylim=YR,ylab=NA,yaxt="n")#ylab="Ratio of Error Approximation to RMSE",xlab="Generated Slope (1D, 2PNO)")
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
text(range(stats1D$A1)[1]+0.8*(range(stats1D$A1)[2]-range(stats1D$A1)[1]),0.85*YR[2],"2PNC")
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1oE,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=1)
mtext(text = "Ratio of Error Approximation to RMSE",side = 2,line = 2.5,cex=0.7,adj=0)
par(mar=c(4,4,m.b,m.b))
plot(stats1D$A1[!stats1D$A1_sd_LMIo==0],
     stats1D$A1_sd_LMIo[!stats1D$A1_sd_LMIo==0]/stats1D$A1_sd[!stats1D$A1_sd_LMIo==0],
     yaxt="n",pch=16,#cex=(SIZE-5000+stats1D$N)/SIZE,
     col=3,ylim=YR,ylab=NA,xlab="Generated Slope (1D, 2PNO)")
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
text(range(stats1D$A1)[1]+0.8*(range(stats1D$A1)[2]-range(stats1D$A1)[1]),0.85*YR[2],"2PNI")
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1o,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=3)
#fitA1oE<-lm(A1_sd_oERR/A1_sd~A1,data=stats1D)
...
par(mar=c(4,5,2,m.b))
plot(stats1D$A1,stats1D$A1_sd_oERR/stats1D$A1_sd,ylab="Ratio of Error Approximation to RMSE",xlab="Generated Slope (1D, 2PNO)",ylim=YR,type="n")
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1oE,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=1)
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1o,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=3)
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1MC,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=4)
lines(seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50),predict(fitA1LM,newdata = data.frame(A1=seq(range(stats1D$A1)[1],range(stats1D$A1)[2],length.out = 50))),lty=5)
...
YR<-c(stats1D$B_sd_oERR,stats1D$B_sd_LMIo,stats1D$B_sd_MCE,stats1D$B_sd_LMI)/stats1D$B_sd
YR<-range(YR[!is.nan(YR)])
#stats1D$B2<-stats1D$B^2

#fitBoE<-lm(B_sd_oERR/B_sd~B+B2,data=stats1D)
fitBoE<-loess(B_sd_oERR/B_sd~B,data=stats1D,span=0.5)
fitBoE
sd(fitBoE$residuals)
#fitBo<-lm(B_sd_LMIo/B_sd~B+B2,data=stats1D)
fitBo<-loess(B_sd_LMIo/B_sd~B,data=stats1D[!stats1D$B_sd_LMIo==0,],span=0.5)
fitBo
sd(fitBo$residuals)
#fitBMC<-lm(B_sd_MCE/B_sd~B+B2,data=stats1D)
fitBMC<-loess(B_sd_MCE/B_sd~B,data=stats1D,span=0.5)
fitBMC
sd(fitBMC$residuals)
#fitBLM<-lm(B_sd_LMI/B_sd~B+B2,data=stats1D)
fitBLM<-loess(B_sd_LMI/B_sd~B,data=stats1D,span=0.5)
fitBLM
sd(fitBLM$residuals)
ticks <- pretty(YR)[-c(length(pretty(YR))-1:0)]
labels <- format(ticks, big.mark=",", scientific=FALSE)
...
# library(gridExtra)
# dev.off()
# df = data.frame(x=stats1D$B,y=stats1D$B_sd_oERR/stats1D$B_sd)
# k <- with(df,MASS:::kde2d(x,y))
# filled.contour(k)
# g<-ggplot(df,aes(x=x,y=y))+geom_density2d()
# ?filled.contour

######################
#     Try loess 95% confidence interval instead.
# plot(cars)
...
plot(stats1D$B,stats1D$B_sd_MCE/stats1D$B_sd,pch=16,col=2,#cex=(SIZE-5000+stats1D$N)/SIZE,
     ylim=YR,xaxt="n",ylab=NA,yaxt="n")
text(range(stats1D$B)[1]+0.8*(range(stats1D$B)[2]-range(stats1D$B)[1]),0.85*YR[2],"MCMC")
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBMC,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=4)

par(mar=c(m.b,4,m.b,m.b))
plot(stats1D$B,stats1D$B_sd_LMI/stats1D$B_sd, pch=16,col=4, #cex=(SIZE-5000+stats1D$N)/SIZE,
     ylim=YR,ylab=NA,yaxt="n")
axis(2,at=ticks,labels=labels,las=2)
text(range(stats1D$B)[1]+0.8*(range(stats1D$B)[2]-range(stats1D$B)[1]),0.85*YR[2],"SAEM")
abline(h=1,lwd=2,lty=2)
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBLM,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=5)
plot(stats1D$B,stats1D$B_sd_oERR/stats1D$B_sd,pch=16,#cex=(SIZE-5000+stats1D$N)/SIZE,
     ylim=YR,ylab=NA,xaxt="n",yaxt="n")#,ylab="Ratio of Error Approximation to RMSE",xlab="Generated Intercepts (1D, 2PNO)")
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
text(range(stats1D$B)[1]+0.8*(range(stats1D$B)[2]-range(stats1D$B)[1]),0.85*YR[2],"2PNC")
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBoE,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=1)
mtext(text = "Ratio of Error Approximation to RMSE",side = 2,line = 2.5,cex = 0.7,adj = 0)
par(mar=c(4,4,m.b,m.b))
plot(stats1D$B[!stats1D$B_sd_LMIo==0],
     stats1D$B_sd_LMIo[!stats1D$B_sd_LMIo==0]/stats1D$B_sd[!stats1D$B_sd_LMIo==0],
     pch=16,#cex=(SIZE-5000+stats1D$N)/SIZE,
     col=3,ylim=YR,ylab=NA,yaxt="n",xlab="Generated Intercepts (1D, 2PNO)")
axis(2,at=ticks,labels=labels,las=2)
abline(h=1,lwd=2,lty=2)
text(range(stats1D$B)[1]+0.8*(range(stats1D$B)[2]-range(stats1D$B)[1]),0.85*YR[2],"2PNI")
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBo,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=3)
# legend("topleft",c("2PNO (At Convergence)","2PNO (Post Convergence)","Iterative","MCMC (Post Convergence)","N = 2000","N = 5000","N = 8000"),
#        pch=c(16,16,3,2,1,1,1),col=c(1,3,4,2,1,1,1),pt.cex=c(1,1,1,1,(SIZE-5000+c(2000,5000,8000))/SIZE))
par(mar=c(4,5,2,m.b))
plot(stats1D$B,stats1D$B_sd_oERR/stats1D$B_sd,ylab="Ratio of Error Approximation to RMSE",xlab="Generated Intercepts (1D, 2PNO)",ylim=YR,type="n")
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBoE,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=1)
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBo,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=3)
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBMC,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=4)
lines(seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),predict(fitBLM,newdata = data.frame(B=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50),B2=seq(range(stats1D$B)[1],range(stats1D$B)[2],length.out=50)^2)),lty=5)
